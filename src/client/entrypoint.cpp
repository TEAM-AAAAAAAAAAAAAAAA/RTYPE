...
ecs::World getGameWorld(ecs::Engine &engine)
{
    ...
    world.registry.addComponent<ecs::component::Drawable>(background1, {ecs::crossPlatformPath("assets", "bg1.png"), {0, 0, 5760, 360}});
    ...
    world.registry.addComponent<ecs::component::Drawable>(backgroundp1, {ecs::crossPlatformPath("assets", "bg1.png"), {0, 0, 5760, 360}});
    ...
    world.registry.addComponent<ecs::component::Drawable>(background2, {ecs::crossPlatformPath("assets", "bg2.png"), {0, 0, 5760, 360}});
    ...
    world.registry.addComponent<ecs::component::Drawable>(backgroundp2, {ecs::crossPlatformPath("assets", "bg2.png"), {0, 0, 5760, 360}});
    ...
    world.registry.addComponent<ecs::component::Drawable>(background3, {ecs::crossPlatformPath("assets", "bg3.png"), {0, 0, 5760, 360}});
    ...
    world.registry.addComponent<ecs::component::Drawable>(backgroundp3, {ecs::crossPlatformPath("assets", "bg3.png"), {0, 0, 5760, 360}});
