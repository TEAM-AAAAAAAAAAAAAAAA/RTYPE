...
ecs::World getGameWorld(ecs::Engine &engine)
{
    ...
    world.registry.addComponent<ecs::component::Drawable>(background1, {ecs::crossPlatformPath("src", "demo", "assets", "textures", "bg1.png"), {0, 0, 5760, 360}});
    ...
    world.registry.addComponent<ecs::component::Animated>(background1, {640, 5760, 0, 0, 0, 15, 0});
    ...
    world.registry.addComponent<ecs::component::Drawable>(backgroundp1, {ecs::crossPlatformPath("src", "demo", "assets", "textures", "bg1.png"), {0, 0, 5760, 360}});
    ...
    world.registry.addComponent<ecs::component::Animated>(backgroundp1, {640, 5760, 0, 0, 0, 15, 0});
    ...
    world.registry.addComponent<ecs::component::Drawable>(background2, {ecs::crossPlatformPath("src", "demo", "assets", "textures", "bg2.png"), {0, 0, 5760, 360}});
    ...
    world.registry.addComponent<ecs::component::Animated>(background2, {640, 5760, 0, 0, 0, 5, 0});
    ...
    world.registry.addComponent<ecs::component::Drawable>(backgroundp2, {ecs::crossPlatformPath("src", "demo", "assets", "textures", "bg2.png"), {0, 0, 5760, 360}});
    ...
    world.registry.addComponent<ecs::component::Animated>(backgroundp2, {640, 5760, 0, 0, 0, 5, 0});
    ...
    world.registry.addComponent<ecs::component::Drawable>(background3, {ecs::crossPlatformPath("src", "demo", "assets", "textures", "bg3.png"), {0, 0, 5760, 360}});
    ...
    world.registry.addComponent<ecs::component::Animated>(background3, {640, 5760, 0, 0, 0, 10, 0});
    ...
    world.registry.addComponent<ecs::component::Drawable>(backgroundp3, {ecs::crossPlatformPath("src", "demo", "assets", "textures", "bg3.png"), {0, 0, 5760, 360}});
    ...
    world.registry.addComponent<ecs::component::Animated>(backgroundp3, {640, 5760, 0, 0, 0, 10, 0});
    return world;
}
