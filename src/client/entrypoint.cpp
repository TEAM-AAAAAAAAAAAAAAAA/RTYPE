...
ecs::World getGameWorld(ecs::Engine &engine)
{
    ...
    world.registry.addComponent<ecs::component::Animated>(background1, {640, 0, 0, 0, 15, 0});
    ...
    world.registry.addComponent<ecs::component::Animated>(backgroundp1, {640, 0, 0, 0, 15, 0});
    ...
    world.registry.addComponent<ecs::component::Animated>(background2, {640, 0, 0, 0, 5, 0});
    ...
    world.registry.addComponent<ecs::component::Animated>(backgroundp2, {640, 0, 0, 0, 5, 0});
    ...
    world.registry.addComponent<ecs::component::Animated>(background3, {640, 0, 0, 0, 10, 0});
    ...
    world.registry.addComponent<ecs::component::Animated>(backgroundp3, {640, 0, 0, 0, 10, 0});
    return world;
}
