...
ecs::World getGameWorld(ecs::Engine &engine)
{
    ...
    world.registry.addComponent<ecs::component::Animated>(background1, AnimFrame(0, 0, 640, 360, 15)); //{640, 0, 0, 0, 5760, 15, 0});
    ...
    world.registry.addComponent<ecs::component::Animated>(backgroundp1, AnimFrame(0, 0, 640, 360, 15)); //{640, 0, 0, 0, 5760, 15, 0});
    ...
    world.registry.addComponent<ecs::component::Animated>(background2, AnimFrame(0, 0, 640, 360, 5)); //{640, 0, 0, 0, 5760, 5, 0});
    ...
    world.registry.addComponent<ecs::component::Animated>(backgroundp2, AnimFrame(0, 0, 640, 360, 5)); //{640, 0, 0, 0, 5760, 5, 0});
    ...
    world.registry.addComponent<ecs::component::Animated>(background3, AnimFrame(0, 0, 640, 360, 10)); //{640, 0, 0, 0, 5760, 10, 0});
    ...
    world.registry.addComponent<ecs::component::Animated>(backgroundp3, AnimFrame(0, 0, 640, 360, 10)); //{640, 0, 0, 0, 5760, 10, 0});
    return world;
}
