...
public:
    ...
    sparse_array(sparse_array const &arr) { this = arr; }    // copy constructor
    sparse_array(sparse_array &&arr) noexcept { this = arr } // move constructor
    ~sparse_array();
    sparse_array &operator=(sparse_array const &arr)
    {
    }     // copy assignment operator
    sparse_array &operator=(sparse_array &&arr) noexcept
    {
    } // move assignment operator
    reference_type operator[](size_t idx) { return _data.at(idx); }
