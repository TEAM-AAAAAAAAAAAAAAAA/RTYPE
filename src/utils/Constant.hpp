...
namespace utils
{
    namespace constant
    {
        ...
        static const std::map<ButtonType, ButtonValue> buttonValueMap {
            {PLAY, {324, 2079, 916, 292, 200, 63, 300, 280}},
            {OPTION, {3651, 2079, 916, 292, 200, 63, 300, 450}},
            {QUIT, {4760, 2079, 916, 292, 200, 63, 300, 620}},
            {PLAY_HOVER, {220, 2449, 1114, 356, 200, 63, 300, 280}},
            {OPTION_HOVER, {3542, 2456, 1114, 356, 200, 63, 300, 450}},
            {QUIT_HOVER, {4670, 2451, 1114, 356, 200, 63, 300, 620}},
            {ROOM, {326, 456, 1114, 356, 400, 63, 800, 250}},
            {OPTION_INTERFACE, {1692, 168, 1589, 1790, 692, 772, 800, 100}},
            {SOUND_LEFT, {3813, 178, 255, 256, 55, 55, 1260, 360}},
            {SOUND_RIGHT, {3489, 434, 255, 256, 55, 55, 1325, 360}},
            {SOUND_LEFT_HOVER, {3489, 178, 255, 256, 55, 55, 0, 0}},
            {SOUND_RIGHT_HOVER, {3813, 434, 255, 256, 55, 55, 0, 0}},
            {HOW_TO, {4137, 434, 255, 256, 55, 55, 0, 0}},
            {HOW_TO_HOVER, {4137, 178, 255, 256, 55, 55, 0, 0}},
            {SLIDE_SOUND, {4396, 1486, 97, 146, 21, 31, 1065, 372}},
            {SLIDE_MUSIC, {4396, 1486, 97, 146, 21, 31, 1065, 572}},
